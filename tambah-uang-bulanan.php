...
//query update
$query = mysqli_query($koneksi,"INSERT INTO `uang_bulanan` (`id`, `id_santri`, `tanggal_pembayaran`, `bulan_pembayaran`, `tahun_pembayaran`, `uang_makan`, `uang_asrama`, `uang_listrik`) VALUES (null, '$id', '$tanggal_pembayaran', '$bulan_pembayaran', '$tahun_pembayaran', '$uang_makan', '$uang_asrama', '$uang_listrik')");
