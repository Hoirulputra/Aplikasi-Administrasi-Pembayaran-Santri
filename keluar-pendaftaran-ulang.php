...
<?php require 'navbar.php'; ?>
      ...
      <div class="float-left">
              <h3 style="margin-top: 5px !important;" class="m-0 font-weight-bold text-primary">Daftar Tagihan Semester Santri</h3>
       </div>
       
       <div class="float-right">

        <?php if ($_COOKIE['logged_akses'] == 'admin' || $_COOKIE['logged_akses'] == 'bendahara') : ?>
        <a style="margin:5px" href="tambah-keluar-pendaftaran-ulang.php" class="btn btn-success btn-sm"><i class="fa fa-plus"></i> Tambah Tagihan</a>
        <?php endif; ?>
        </div>
...
<input type="date" value="<?php echo $row['tanggal_tagihan']; ?>" readonly required  value="<?php echo $row['tanggal_tagihan']; ?>" class="form-control">
