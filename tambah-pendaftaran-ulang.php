...
$uang_pendafaftaran_ulang = $_GET['uang_pendafaftaran_ulang'];
...
//query update
$query = mysqli_query($koneksi,"INSERT INTO `pendaftaran_ulang` (`id`, `id_santri`, `uang_pendafaftaran_ulang`, `uang_ujian`, `tanggal_pembayaran`, `tahun_pembayaran`, `semester_pembayaran`) VALUES (null, '$id', '$uang_pendafaftaran_ulang', '$uang_ujian', '$tgl_pembayaran', '$tahun_pembayaran', '$semester_pembayaran')");
