...
//query update
$query = mysqli_query($koneksi,"INSERT INTO `keluar_uang_bulanan` (`id`, `tanggal_tagihan`, `nominal_tagihan`, `ket_tagihan`, `jenis_tagihan`) VALUES (null, '$tanggal_tagihan', '$nominal_tagihan', '$ket_tagihan', '$jenis_tagihan')");
