...
//query update
$query = mysqli_query($koneksi,"UPDATE keluar_pendaftaran_ulang SET tanggal_tagihan='$tanggal_tagihan' , nominal_tagihan='$nominal_tagihan', ket_tagihan='$ket_tagihan', jenis_tagihan='$jenis_tagihan' WHERE id='$id' ");
