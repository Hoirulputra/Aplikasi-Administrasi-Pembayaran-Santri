          ...
          <div class="card shadow mb-4">
			...
			<div class="float-left">
			 ...
			 <div class="float-right">			  
			  <a style="margin:5px" href="sudah-uang-bulanan.php" class="btn btn-success btn-sm"><i class="fa fa-eye"></i> Daftar Santri Sudah Bayar Uang Bulanan</a>
			  </div>
            ...
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <tbody>
				  <?php 
$query = mysqli_query($koneksi,"SELECT * FROM santri WHERE status='Lama' AND uang_bulanan='Belum'");
$no = 1;
...
?>
                    <tr>
                      ...
                      <td><?=$data['alamat']?></td>
					  <td style="text-align:center;"><span class="btn btn-warning btn-sm"><?=$data['uang_bulanan']?></span></td>
